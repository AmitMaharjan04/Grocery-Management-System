...
//            jTable1.setModel(DbUtils.resultSetToTableModel(rs));
        while(rs.next()){
            String id=String.valueOf(rs.getInt("l_id"));
            String cashier=String.valueOf(rs.getString("username"));
            String date=String.valueOf(rs.getDate("date"));
            String time=String.valueOf(rs.getTime("time"));
            String total=String.valueOf(rs.getInt("total"));
            
            String tableData[]={id,cashier,date,time,total};
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(920, 591));
        ...
        jLabel2.setText("Select the day of logs");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         ...
         if(log.equals("Today")==true){
                today();
         }
         if(log.equals("Yesterday")==true){
                yesterday();
         }
         if(log.equals("This Month")==true){
            thisMonth();
         }
         if(log.equals("Past Month")==true){
            pastMonth();
         }
         if(log.equals("This Year")==true){
            thisYear();
         }
    ...
    public void today(){
        DefaultTableModel tbModel=(DefaultTableModel)jTable1.getModel();
        int id=0;
            String query="select * from logs where date=?";
             Date d=new Date();
            ...
            while(rs.next()){
                id++;
                String name=String.valueOf(rs.getString("username"));
                String date=String.valueOf(rs.getDate("date"));
                String time=String.valueOf(rs.getTime("time"));
                String total=String.valueOf(rs.getInt("total"));
            
                String tableData[]={String.valueOf(id),name,date,time,total};
                tbModel.addRow(tableData);
        }
            pstmt.close();
            con.close();
        ...
        String query="select * from logs where date=?";
         ...
         String date="2022-08-".concat(String.valueOf(day1));
            ...
            while(rs.next()){
                ...
                String tableData[]={String.valueOf(id),name,date1,time,total};
                tbModel.addRow(tableData);
        }
            pstmt.close();
            con.close();
    ...
    public void pastMonth(){
        DefaultTableModel tbModel=(DefaultTableModel)jTable1.getModel();
            int id=0;
        String query="select * from logs where date between ? and ? order by date asc";
             Date d=new Date();
    ...
    public void thisMonth(){
        ...
        String query="select * from logs where date between ? and ? order by date asc";
         ...
         String date="2022-0".concat(String.valueOf(currentMonth)).concat("-01");
